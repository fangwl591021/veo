...
async function home() {
  ...
  layout(`<section class="member-portal ak-home-banner"><button type="button" class="portal-primary" data-home-action="wallet"><div><span>有點開心</span><strong>${format(wallet.balance)}</strong></div></button><button type="button" class="portal-primary" data-home-action="zodiac"><div><span>星座運勢</span></div></button><button type="button" class="portal-primary ak-share-entry" data-home-action="share"><span class="ak-share-qr-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M3 3h7v7H3zM14 3h7v7h-7zM3 14h7v7H3zM15 14h2v2h-2zM19 14h2v4h-2zM14 18h3v3h-3zM19 20h2v1h-2z"/></svg></span><span>專屬分享</span></button></section><section class="ak-dashboard">
