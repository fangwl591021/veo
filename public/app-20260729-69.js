...
async function home() {
  ...
  const posts = results[1].status === "fulfilled" ? (results[1].value.posts || []) : [];
  ...
  layout(`<section class="member-portal ak-home-banner"><button type="button" class="portal-profile" data-home-action="profile" aria-label="開啟會員資料">${avatar()}<strong>${esc(greeting)}</strong><small>${dateText}</small></button><button type="button" class="portal-primary" data-home-action="wallet"><div><span>商脈點數</span><strong>${format(wallet.balance)}</strong></div></button><button type="button" class="portal-primary" data-home-action="share"><div><span>專屬分享</span><strong>分享</strong></div></button></section><section class="ak-dashboard">
    <section class="ak-home-content">
      <div class="ak-feature-grid">
        ...
        <button data-home-action="zodiac"><span>星座運勢</span></button>
        <button data-home-action="calendar"><span>個人行事曆</span></button>
        <button data-home-action="courses"><span>活動中心</span></button>
        <button data-home-action="wallet"><span>商脈錢包</span></button>
      </div>
      <img class="ak-moment-banner" src="/akaffit-moment-banner.png" alt="自在適合，每一刻">
      <section class="ak-official-site" aria-label="A’kaffit 品牌官網內容">
        <header class="ak-official-masthead">
          <img src="/akaffit-logo.png" alt="A’kaffit">
          <small>COFFEE · WELLNESS · CONNECTION</small>
          <h2>讓一杯好咖啡，成為彼此靠近的開始</h2>
          <p>從豆子的風土、烘焙的節奏到入口的香氣，A’kaffit 專注每一段細節，把咖啡帶進健康、講究而有溫度的日常。</p>
        </header>
        <nav class="ak-official-nav" aria-label="品牌內容導覽"><a href="#ak-brand-story">品牌故事</a><a href="#ak-coffee-craft">咖啡工藝</a><a href="#ak-fermentation">酒釀發酵</a><a href="#ak-coffee-guide">咖啡百科</a></nav>
        <section class="ak-brand-story" id="ak-brand-story">
          <div><small>ABOUT A’KAFFIT</small><h3>在風味與生活之間，找到剛好的平衡</h3><p>A’kaffit 相信咖啡不只是飲品，而是一種連結人的方式。我們從產地與選豆出發，追求清楚的風味、穩定的品質，以及每一天都能輕鬆享受的咖啡體驗。</p></div>
          <div class="ak-brand-monogram" aria-hidden="true"><span>A’</span><b>kaffit</b></div>
        </section>
        <section class="ak-craft-section" id="ak-coffee-craft">
          <header><small>COFFEE CRAFT</small><h3>從一顆豆，到一杯好咖啡</h3><p>把官網的咖啡十大工藝，整理成四個最容易理解的風味階段。</p></header>
          <div class="ak-craft-grid"><article><i>01</i><strong>產地選豆</strong><p>依產區、海拔與處理法挑選風味清楚、品質穩定的咖啡豆。</p></article><article><i>02</i><strong>專業烘焙</strong><p>用溫度與時間發展甜感、香氣與乾淨尾韻，留下豆子的特色。</p></article><article><i>03</i><strong>精準研磨</strong><p>配合沖煮方式調整粗細，讓萃取均勻、風味平衡。</p></article><article><i>04</i><strong>用心沖煮</strong><p>掌握水溫、比例與時間，在日常中穩定重現理想風味。</p></article></div>
        </section>
        <section class="ak-fermentation-section" id="ak-fermentation">
          <div class="ak-fermentation-mark" aria-hidden="true">醞</div><div><small>SIGNATURE PROCESS</small><h3>獨創酒釀發酵技術</h3><p>透過發酵條件與時間控制，讓咖啡展現更有層次的香氣、圓潤甜感與細緻口感。從傳統釀造得到靈感，再用現代製程維持每一批風味的一致。</p><span>香氣層次</span><span>圓潤甜感</span><span>細緻尾韻</span></div>
        </section>
        <section class="ak-catalog-section">
          <header><small>EXPLORE A’KAFFIT</small><h3>找到適合你的咖啡日常</h3></header>
          <div class="ak-catalog-grid"><article><i>人氣</i><strong>人氣商品</strong><p>從大家喜愛的風味開始探索。</p></article><article><i>輕享</i><strong>濾掛咖啡</strong><p>簡單沖泡，也能享受完整香氣。</p></article><article><i>選豆</i><strong>咖啡豆</strong><p>依產區與焙度挑選你的日常風味。</p></article><article><i>心意</i><strong>禮盒專區</strong><p>把咖啡與祝福一起分享。</p></article><article><i>沖煮</i><strong>沖煮器具</strong><p>讓每一次沖煮更穩定、更好喝。</p></article><article><i>生活</i><strong>健康生活</strong><p>從咖啡延伸到更好的生活節奏。</p></article></div>
        </section>
        <section class="ak-guide-intro" id="ak-coffee-guide"><small>COFFEE JOURNAL</small><h3>咖啡百科</h3><p>品牌故事、咖啡知識、沖泡教學、健康生活與精選專題，都會在這裡持續更新。</p></section>
      </section>
  ...
  </section><section id="sharePanel" class="card qr-card quick-panel hidden"><h3>我的推薦網址 QR 碼</h3><p class="muted">朋友掃描或開啟網址後，會帶入你的系統推薦關係。</p><div id="shareQr" class="qr"></div><p id="shareInviteUrl" class="share-invite-url" aria-label="推薦網址"></p><button class="btn alt" id="copyInvite">分享推薦網址</button></section>`);
}
