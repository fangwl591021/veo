...
function layout(body) {
  ...
  const headerActions = `<div class="feature-header-actions">${cardCollectionAction}<button class="feature-header-action feature-home-action" data-home-action="home">返回首頁</button></div>`;
